...
<?php
 ...
 <?php 
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
        $updateCus = $cmr->customerUpdate($_POST,$cusId);
    }
?>
         ...
         <form action="" method="post">
          <table class="tblone">
              <?php 
               ...
               ?>
              <tr><td colspan="2" class="caption1">Update Profile Details</td></tr>
              <tr>
                <td>Name</td>
              ...
              <tr>
                <td></td>
                <td colspan=""><input type="submit" name="submit" value="Update Now"></td>
              </tr>
